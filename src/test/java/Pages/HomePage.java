...
public class HomePage extends BasePage {
    ...
    public void validateHomePage(HomepageObj homepageObj) {
        ...
        elementMethods.validateMessage(welcomeMessage, homepageObj.getWelcomeMessage());
        LoggerUtility.info("The welcome message has been identified: " + homepageObj.getWelcomeMessage());
        pageMethods.scrollByPixel(0, 200);
        LoggerUtility.info("Scrolling down by 200 pixels.");
        elementMethods.validateMessage(featuredProductsMessage, homepageObj.getFeaturedProductsMessage());
        LoggerUtility.info("The welcome featured products message has been identified: " + homepageObj.getFeaturedProductsMessage());
    }
