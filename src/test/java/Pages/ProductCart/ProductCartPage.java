...
public class ProductCartPage extends BasePage {
    ...
    public void cartValidation(ProductCartObj productCartObj){
        ...
        elementMethods.fillElement(enterCoupon,productCartObj.getCupon());
        LoggerUtility.info("The user enters the coupon code : " +productCartObj.getCupon()+" .");
    ...
    public void checkoutProducts(ProductCartObj productCartObject){
