...
public class ChangePasswordPage extends BasePage {
    ...
    public void createNewPasswordMethod(RegisterPageObj registerPageObj){
        elementMethods.fillElement(oldPasswordField,registerPageObj.getPassword());
        LoggerUtility.info("The user fills old password field.");
        elementMethods.fillElement(newPasswordField,registerPageObj.getNewPassword());
        LoggerUtility.info("The user fills new password field.");
        elementMethods.fillElement(confirmNewPassword,registerPageObj.getNewPassword());
