...
public class MyAccountPage extends BasePage {
    ...
    public void validateCustomerInfo(RegisterPageObj registerPageObj){
        elementMethods.validateElementValue(firstNameField, registerPageObj.getFirstName());
        LoggerUtility.info("The first name value has been validated with success.");
        elementMethods.validateElementValue(lastNameField, registerPageObj.getLastName());
        LoggerUtility.info("The last name value has been validated with success.");
        elementMethods.validateElementValue(emailField, registerPageObj.getEmail());
